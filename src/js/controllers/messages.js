...
app.controller('messages', ['$scope', 'Api', '$ionicPopup','Toast' ,'VisitorsService','$rootScope','SessionService','$http','API_URL',function($scope, Api, $ionicPopup, Toast,VisitorsService,$rootScope,SessionService, $http,API_URL) {
